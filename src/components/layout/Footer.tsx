        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-gradient-ocean rounded-full flex items-center justify-center overflow-hidden">
                <img
                  src={logo}
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                ...
                <span>No.115/26/A/1 Shop No.2: Poorna Pragna Layout 10th main Road Cauvery Nagar Banashankari Stage 3 Bengaluru 560085</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-primary flex-shrink-0" />
                <span>+91 98457 42597</span>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li>• Corporate Day Outing Package</li>
              <li>• Visa Services</li>
              <li>• Flight & Cab Services</li>
              <li>• Fitness & SPA</li>
            </ul>
          </div>
